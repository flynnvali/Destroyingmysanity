...
public class DestroyBlocksConfigs extends DestroyConfigBase {
    ...
    public final ConfigFloat blazeBurnerHeatingTemperature = f(500f, -Float.MAX_VALUE, Float.MAX_VALUE, "blazeBurnerHeatingTemperature", "The difference in temperature between kindled Blaze Burners and the environment.");
    public final ConfigFloat blazeBurnerSuperHeatingTemperature = f(1500f, -Float.MAX_VALUE, Float.MAX_VALUE, "blazeBurnerSuperHeatingTemperature", "The difference in temperature between superheating Blaze Burners and the environment");
    public final ConfigFloat coolerHeatingTemperature = f(-500f, -Float.MAX_VALUE, Float.MAX_VALUE, "coolerHeatingTemperature", "The difference in temperature between cooling Refrigerstraytors and the environment");
